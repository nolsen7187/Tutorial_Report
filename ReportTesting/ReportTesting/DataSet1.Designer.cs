...
namespace ReportTesting {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Phone, string Email, string Street) {
...
namespace ReportTesting.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([FirstName], [LastName], [Phone], [Email], [Street]) VAL" +
                "UES (@FirstName, @LastName, @Phone, @Email, @Street);\r\nSELECT CustomerId, FirstN" +
                "ame, LastName, Phone, Email, Street FROM Customers WHERE (CustomerId = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Phone] = @Phone, [Email] = @Email, [Street] = @Street WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Street = 1 AND [Street] IS NULL) OR ([Street] = @Original_Street)));
SELECT CustomerId, FirstName, LastName, Phone, Email, Street FROM Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ReportTesting.Properties.Settings.Default.FFRConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, FirstName, LastName, Phone, Email, Street FROM Customers\r\nWher" +
        ...
        public virtual int Fill(DataSet1.CustomersDataTable dataTable, string FirstName) {
        ...
        public virtual DataSet1.CustomersDataTable GetData(string FirstName) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((FirstName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(int Original_CustomerId, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Street) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Phone, string Email, string Street) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, string Street, int Original_CustomerId, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Street, int CustomerId) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, string Street, int Original_CustomerId, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Street) {
            return this.Update(FirstName, LastName, Phone, Email, Street, Original_CustomerId, Original_FirstName, Original_LastName, Original_Phone, Original_Email, Original_Street, Original_CustomerId);
        }
    }
